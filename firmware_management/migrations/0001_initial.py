    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_item_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='firmware', to='netbox_inventory.inventoryitemtype')),
        ...
        migrations.AddConstraint(
            model_name='firmware',
            constraint=models.CheckConstraint(condition=models.Q(('manufacturer__isnull', False), models.Q(('device_type__isnull', True), ('inventory_item_type__isnull', True), ('manufacturer__isnull', True), ('module_type__isnull', True)), _connector='OR'), name='either_manufacturer_or_device_type_or_inventory_item_type_or_module_type_required'),
        ),
